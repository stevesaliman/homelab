...
Because [this project](https://github.com/stevesaliman/homelab) applies GitOps practices,
it's the source of truth for _my_ homelab, so you'll need to fork it to make it yours:

[:fontawesome-solid-code-fork: Fork stevesaliman/homelab](https://github.com/stevesaliman/homelab/fork){ .md-button }
